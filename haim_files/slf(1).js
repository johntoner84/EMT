...
var ANRDF=1;
var ANSCC="unescape(isSocialNetworkShared()+document.referrer+'tactag:'+aolFrameParams('tags')+catmanduLogger()+catmandu_integration_mcc_m(aolTacRef(), document.referrer, '/search.*[?&]q=([^&]+)')).toLowerCase()";
var ANTPUD;
var ANVDT=0;
var CCLOOKUP22='AAAMmichael-jackson-concert|A#MUSkveditags.*primacy.music|A#TEVtactag:.*television|AABU/entertainment|BMOVfilm/|BTEVtelevision|AEWVtwitter.com|A#EWUfacebook.com.l.php|AECMsocialnetwork:share|TECI:facebook|UFILgoogleplus|UECKlifestream|UEUMtwitter|UEWTfacebook:like|[FIQok:recommend|UFIWstumbleupon|UFIXfacebook:read|AABUhuffingtonpost.com';
var ANAXLSL='';
var ANCB1=0;
var ANCB3=0;
var ANRD='';
